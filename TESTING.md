...
```bash
# Run all tests with default PHP 8.5
make test
...
make test-8.5   # Test with PHP 8.5 (default)
...
- **php84** - PHP 8.4 container for running tests
- **php85** - PHP 8.5 container for running tests (default)
